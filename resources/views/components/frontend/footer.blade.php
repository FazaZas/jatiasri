    ...
    <section class="">
      <div class="border-t border-b border-gray-200 py-12 mt-16 px-4">
        <div class="flex justify-center mb-8">
          <img
            src="{{ url('/frontend/images/content/jatiasri-logo-text.png') }}"
    ...
    <footer class="flex text-center px-4 py-8 justify-center">
      <p class="text-sm">
        UD. Jati Asri 1 • Jl. Diponegoro No.18, Sukorejo Lor, Sumbang Kec. Bojonegoro, Kabupaten Bojonegoro, Jawa Timur 62115
      </p>
    </footer>
    <!-- END: FOOTER -->
