...
<!-- Illustrations -->
    <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold">Selamat datang di toko Jatiasri</h6>
            </div>
            <div class="card-body">
                <div class="center">
                ...
                <p>Jatiasri menjual berbagai produk mebel yang anda butuhkan,
                    ...
                    Lengkapi ruangan anda dengan mebel yang kami sediakan</p>
                <a target="_blank" rel="nofollow" href="{{ route('index') }}">Cari produk mebel yang anda inginkan &rarr;</a>
            </div>
        </div>
