    ...
    <section class="bg-gray-100 py-8 px-4">
      <div class="container mx-auto">
        <ul class="breadcrumb">
          ...
          <li>
            <a href="#" aria-label="current-page">keranjang</a>
          </li>
        </ul>
      </div>
    </section>
          ...
          <div class="w-full md:px-4 md:w-4/12" id="shipping-detail">
            <div class="bg-gray-100 px-4 py-6 md:p-8 md:rounded-3xl">
              <form action="{{ route('checkout') }}" method="POST">
                ...
                <div class="flex flex-col mb-4">
                  <label for="email" class="text-sm mb-2">E-Mail</label>
                  <input
                    data-input
                    name="email"
                    type="email"
                ...
                <div class="flex flex-col mb-4">
                  ...
                  <div class="flex -mx-2 flex-wrap">
                    ...
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/frontend/images/content/Sicepat Express Logo Vector_Red.svg"
                          alt="Logo Fedex"
                          class="object-contain max-h-full"
                        />
                      </button>
                    ...
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/frontend/images/content/JNE Logo_vectrostudio.svg"
                          alt="Logo Fedex"
                          class="object-contain max-h-full"
                        />
                      </button>
                    ...
                    <div class="px-2 w-6/12 h-24 mb-4">
                      ...
                      >
                        <img
                          src="/frontend/images/content/j-t-express-seeklogo.com.svg"
                          alt="Logo Fedex"
                          class="object-contain max-h-full"
                        />
                      </button>
