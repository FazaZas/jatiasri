    ...
    <section class="container mx-auto">
      <div class="flex flex-wrap my-4 md:my-12">
        <div class="w-full md:hidden px-4">
          <h2 class="text-5xl font-semibold">Kursi Tamu</h2>
          ...
          <div class="slider">
            <div class="thumbnail">
              <div class="px-2">
                <div
                  class="item selected"
                  data-img="/frontend/images/content/kursi-tamu-flip.png"
                >
                  <img
                    src="/frontend/images/content/kursi-tamu-flip.png"
                    alt="front"
              ...
              <div class="px-2">
                <div
                  class="item"
                  data-img="/frontend/images/content/kursi-tamu.png"
                >
                  <img
                    src="/frontend/images/content/kursi-tamu.png"
                    alt="back"
                    class="object-cover w-full h-full rounded-lg"
                  />
                </div>
            ...
            <div class="preview">
              <div class="item rounded-lg h-full overflow-hidden">
                <img
                  src="/frontend/images/content/kursi-tamu-1.png"
                  alt="front"
                  class="object-cover w-full h-full rounded-lg"
                />
              </div>
        ...
        <div class="flex-1 px-4 md:p-6">
          ...
          <a
            ...
            Masukan Ke Keranjang</a
          >
          <hr class="my-8" />

          <h6 class="text-xl font-semibold mb-4">Tentang produk</h6>
          <p class="text-xl leading-7 mb-6">
            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sed quod iure quisquam adipisci? Libero suscipit iure commodi ullam dolorum a perspiciatis? Nisi quisquam perferendis explicabo praesentium, corrupti dolorem. Tempora, quis!
          </p>
          <p class="text-xl leading-7">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Explicabo ipsam earum perferendis minus. Quo praesentium voluptate aliquid sed ab consequatur, perspiciatis doloremque optio earum quaerat dolor ut molestiae laudantium porro!
          </p>
        </div>
      </div>
    </section>
      ...
      <div class="container mx-auto">
        <div class="flex flex-start mb-4">
          <h3 class="text-2xl capitalize font-semibold">
            Lengkapi ruangan anda <br class="" />dengan mebel yang kami sediakan untuk anda
          </h3>
        </div>
        <div class="flex overflow-x-auto mb-4 -mx-3">
          <div class="px-3 flex-none" style="width: 320px">
            <div class="rounded-xl p-4 pb-8 relative bg-white">
              <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                <img
                  src="/frontend/images/content/jam.jpg"
                  alt=""
                  class="w-full h-full object-cover object-center"
                />
              </div>
              <h5 class="text-lg font-semibold mt-4">Jam Berdiri</h5>
              <span class="">IDR 5.300.000</span>
          ...
          <div class="px-3 flex-none" style="width: 320px">
            <div class="rounded-xl p-4 pb-8 relative bg-white">
              <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                <img
                  src="/frontend/images/content/mimbar.jpg"
                  alt=""
                  class="w-full h-full object-cover object-center"
                />
              </div>
              <h5 class="text-lg font-semibold mt-4">Mimbar Ukir</h5>
              <span class="">IDR 15.500.399</span>
              <a href="details.html" class="stretched-link">
                <!-- fake children -->
              </a>
            </div>
          ...
          <div class="px-3 flex-none" style="width: 320px">
            <div class="rounded-xl p-4 pb-8 relative bg-white">
              <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                <img
                  src="/frontend/images/content/kursi.jpg"
                  alt=""
                  class="w-full h-full object-cover object-center"
                />
              </div>
              <h5 class="text-lg font-semibold mt-4">Kursi Makan</h5>
              <span class="">IDR 1.000.000</span>
              <a href="details.html" class="stretched-link">
                <!-- fake children -->
              </a>
            </div>
          ...
          <div class="px-3 flex-none" style="width: 320px">
            <div class="rounded-xl p-4 pb-8 relative bg-white">
              <div class="rounded-xl overflow-hidden card-shadow w-full h-36">
                <img
                  src="/frontend/images/content/lemari-baju.jpg"
                  alt=""
                  class="w-full h-full object-cover object-center"
                />
              </div>
              <h5 class="text-lg font-semibold mt-4">Lemari Baju</h5>
              <span class="">IDR 3.399.999</span>
              <a href="details.html" class="stretched-link">
                <!-- fake children -->
              </a>
            </div>
