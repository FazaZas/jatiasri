...
@section('content')
    ...
    <section class="flex items-center hero">
      ...
      >
        <h2 class="text-3xl md:text-5xl leading-tight font-semibold">
          Mebel berkelas <br class="" />Ruangan nyaman
        </h2>
        <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
          Jl. Diponegoro No.18, Sukorejo Lor, Sumbang
          <br class="hidden lg:block" /> Kec. Bojonegoro, Kabupaten Bojonegoro, Jawa Timur 62115
        </h2>
        <div>
          <a
      ...
      <div class="w-full inset-0 md:relative md:w-1/2">
        <div class="relative hero-image">
            ...
            <button
              ...
              <div class="absolute w-full h-full">
                <iframe 
                    width="100%" 
                    height="100%" 
                    src="https://www.youtube.com/embed/tiUYZ-3InrY" 
          ...
          <img
            src="/frontend/images/content/jatiasri-tempat.png"
            alt="hero 1"
      ...
      <div class="container mx-auto">
        <div class="flex flex-start mb-4">
          <h3 class="text-2xl capitalize font-semibold">
            Kami menawarkan beberapa jenis mebel <br class="" />yang telah kami desain untuk anda
          </h3>
        </div>
    ...
    <section class="flex flex-col py-16">
      <div class="container mx-auto mb-4">
        <div class="flex justify-center text-center mb-4">
          <h3 class="text-2xl capitalize font-semibold">
            Beberapa produk yang kami tawarkan <br class="" />mungkin mebel ini yang anda cari
          </h3>
        </div>
      </div>
      <div class="overflow-x-hidden px-4" id="carousel">
        ...
        <div class="flex -mx-4 flex-row relative">
          ...
          <div class="px-4 relative card group">
            ...
            <h5 class="text-lg font-semibold mt-4">Mimbar Ukir Jati Asli</h5>
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/frontend/images//content/lemari-sudut.jpg"
                alt=""
                class="w-full h-full object-cover object-center"
              />
            </div>
            <h5 class="text-lg font-semibold mt-4">Lemari Sudut</h5>
            <span class="">IDR 3.599.400</span>
            <a href="#details.html" class="stretched-link">
              <!-- fake children -->
            </a>
          </div>
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/frontend/images//content/sangkar-burung.jpg"
                alt=""
                class="w-full h-full object-cover object-center"
              />
            </div>
            <h5 class="text-lg font-semibold mt-4">Sangkar Burung</h5>
            <span class="">IDR 2.599.400</span>
            <a href="#details.html" class="stretched-link">
              <!-- fake children -->
            </a>
          </div>
          ...
          <div class="px-4 relative card group">
            ...
            >
              ...
              <img
                src="/frontend/images//content/kaligrafi.jpg"
                alt=""
                class="w-full h-full object-cover object-center"
              />
            </div>
            <h5 class="text-lg font-semibold mt-4">Kaligrafi Ukir</h5>
            <span class="">IDR 5.599.400</span>
            <a href="#details.html" class="stretched-link">
              <!-- fake children -->
            </a>
          </div>
