...
@section('content')
    ...
    <section class="flex items-center hero">
      ...
      >
        <h1 class="text-3xl md:text-5xl leading-tight font-semibold">
          Jatiasri<br class="" />Bojoengoro
        </h1>
        <h2 class="px-8 text-base md:px-0 md:text-lg my-6 tracking-wide">
          Kami menyediakan mebel berkelas
          <br class="hidden lg:block" />untuk melengkapi rumah anda
        </h2>
        <div>
          <a
            ...
            <button
              ...
              <div class="absolute w-full h-full">
                <iframe
                  width="100%"
                  height="100%"
                  src="{{ url('https://www.youtube.com/embed/tiUYZ-3InrY') }}"
                  frameborder="0"
      ...
      <div class="container mx-auto">
        <div class="flex flex-start mb-4">
          <h3 class="text-2xl capitalize font-semibold">
            Kategori mebel yang<br class="" />kami desine untuk anda
          </h3>
        </div>
        <div class="grid grid-rows-2 grid-cols-9 gap-4">
          ...
          >
            ...
            >
              <h5 class="text-lg font-semibold">Lainya</h5>
              <span class="">25 Mebel</span>
            </div>
            <a href="{{ route('details', 'slug') }}" class="stretched-link">
              <!-- fake children -->
            </a>
    ...
    <!-- START: JUST ARRIVED -->
    <section class="flex flex-col py-16" id="katalog">
      <div class="container mx-auto mb-4">
        <div class="flex justify-center text-center mb-4">
          <h3 class="text-2xl capitalize font-semibold">
            Beberapa mebel baru dari kami <br class="" />untuk melengkapi rumah anda
          </h3>
        </div>
      </div>
